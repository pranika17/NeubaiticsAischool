...
const AddQuizQuestion = () => {
    ...
    _formData.append('quiz', quiz_id); // quiz ID from params
    ...
    try {
        axios.post(baseUrl + '/quiz-questions/', _formData, {  // ✅ correct URL
            headers: {
        ...
        <div className='col-9'>
            <div className='card'>
                ...
                <div className='card-body'>
                    ...
                    <div className="mb-3">
                        <label htmlFor="title" className="form-label">Ans4</label>
