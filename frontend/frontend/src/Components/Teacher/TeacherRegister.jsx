...
const TeacherRegister = () => {
  ...
  const submitForm = () => {
    ...
    axios
      ...
      .then((response) => {
        const teacherCode = response.data?.teacher_code || "";
        setGeneratedTeacherId(teacherCode);
        setTeacherData({
          full_name: "",
          email: "",
          password: "",
    ...
    html: `
        <b>Registered Successfully!</b><br/>
        <span style="font-size:14px;">Your Teacher ID is <b>${teacherCode || "Generated"}</b>.<br/>
    ...
    <div className="register-card shadow-lg">
      ...
      {generatedTeacherId ? (
        <div className="alert alert-info rounded-4 border-0">
          Your generated Teacher ID: <strong>{generatedTeacherId}</strong>
        </div>
      ) : null}
      ...
      <div className="form-floating mb-3">
        <input
          type="text"
          className="form-control custom-input"
          value={generatedTeacherId || "Auto-generated after registration"}
          readOnly
