        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Generate accurate, course-specific assessment questions. "
...
""",
        ...
        response = client.chat.completions.create(
            ...
            messages=messages,
            temperature=0.65,
            max_tokens=int(os.getenv("OPENAI_QUIZ_MAX_TOKENS", "1200")),
        )
            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Generate STRICT JSON only with realistic, course-specific interview questions. "
                        "The flow should resemble a real interview: self introduction, basic fundamentals, practical development, and coding when relevant. "
                        "Questions must reflect what the student studied in the enrolled course and what they may build in development work. "
                        "Do not use markdown."
                    ),
                },
                {
...
""",
        ...
        return {
            ...
            "missing_points": str(parsed.get("missing_points", "")).strip(),
