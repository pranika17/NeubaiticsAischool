  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        const enrollments = (Array.isArray(enrollmentsRes.data) ? enrollmentsRes.data : []).filter(
                  ...
                  <div className="student-interview-last">
                    <span>
                      {lastInterview.status === "completed"
                        ? `Last score: ${lastInterview.overall_score || 0}`
                    ...
                    >
                      {lastInterview.status === "completed" ? "View Report" : "Resume Interview"}
                    </Link>
                  </div>
                )}
              </div>
